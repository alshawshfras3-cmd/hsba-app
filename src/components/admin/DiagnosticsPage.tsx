...
export function DiagnosticsPage() {
  ...
  return (
    <div className="space-y-8" id="admin-diagnostics-container">
      ...
      {hasMissingDsrRules && (
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 shadow-xs flex flex-row items-center justify-between gap-4 font-sans text-right" id="missing-dsr-rules-diagnostic-banner">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#78350F] mt-1.5 leading-relaxed">
                توجد {missingDsrRules.length} قاعدة (قواعد) استقطاع DSR غير معرفة في لوحة التحكم لبعض المنتجات أو الجهات التمويلية. عدم وجود هذه القواعد قد يؤثر على دقة محاكاة الحساب الائتماني.
              </p>
            </div>
          </div>
        </div>
