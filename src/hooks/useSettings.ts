...
export function useSettings() {
  ...
  return {
    ...
    dsrRules: normalizeDsrRules(settings.dsrRules ?? settings.dsr_rules ?? DEFAULTS.dsr_rules).map((r: any) => ({ ...r, productType: normalizeMemoryProductId(r.productType || r.productId) })),
