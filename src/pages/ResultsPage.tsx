      ...
      <div className="max-w-md mx-auto my-16 px-4 text-center select-none" dir="rtl">
        <div className="bg-white dark:bg-[#111827] border border-gray-100 dark:border-slate-800/80 rounded-3xl p-8 shadow-xl space-y-6">
          ...
          <div className="space-y-2">
            <h3 className="font-sans font-black text-xl text-gray-950 dark:text-white">سجّل دخولك لمشاهدة نتائجك</h3>
          ...
          <button
            ...
            className="w-full py-3.5 bg-[#0057B8] dark:bg-[#2563EB] hover:bg-[#004bb0] dark:hover:bg-[#1d4ed8] text-white text-xs font-extrabold rounded-2xl transition-all shadow-md hover:shadow-blue-200 cursor-pointer flex items-center justify-center gap-2"
          >
    ...
    return (
      <div className="max-w-md mx-auto my-16 px-4 text-center select-none" dir="rtl">
        <div className="bg-white dark:bg-[#111827] border border-gray-100 dark:border-slate-800/80 rounded-3xl p-8 shadow-xl space-y-6">
          ...
          <div className="space-y-2">
            <h3 className="font-sans font-black text-xl text-gray-950 dark:text-white">لا توجد نتائج محفوظة بعد</h3>
            <p className="text-xs text-slate-500 dark:text-slate-400 leading-relaxed font-sans">
          ...
          <button
            ...
            className="w-full py-3.5 bg-[#0057B8] dark:bg-[#0ea5a4] hover:bg-[#004bb0] dark:hover:bg-[#0c8584] text-white text-xs font-extrabold rounded-2xl transition-all shadow-md hover:shadow-blue-200 cursor-pointer flex items-center justify-center gap-2"
          >
    ...
    <div className="w-full bg-[#F5F7FA] dark:bg-[#0B0F19] min-h-screen pb-16" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 pt-8">
        ...
        <div className="bg-white/50 dark:bg-[#111827]/40 border border-emerald-100 dark:border-emerald-900/30 rounded-2xl p-4 mb-6 flex items-center gap-3 text-right max-w-7xl mx-auto">
          <div className="w-8 h-8 bg-emerald-50 dark:bg-emerald-950/20 rounded-lg flex items-center justify-center text-emerald-600 dark:text-emerald-400 shrink-0">
            ...
            return (
              ...
              >
                ...
                <div className="p-5 text-right space-y-4 flex-1">
                  ...
                  <div>
                    <h4 className="font-extrabold text-xs text-slate-800 dark:text-slate-200 leading-snug">{item.title}</h4>
                    {item.customer_name && (
                  ...
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-[11px] font-semibold text-slate-600 dark:text-slate-300 border-t border-slate-100 dark:border-slate-800 pt-3">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-extrabold text-slate-800 dark:text-slate-100">{Math.round(item.term_months / 12)} سنوات</span>
                    </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800/80 rounded-2xl p-4.5 space-y-3 shadow-xs font-medium">
                <div className="flex justify-between items-center pb-2.5 border-b border-slate-100 dark:border-slate-800">
                  <h3 className="font-extrabold text-sm text-slate-800 dark:text-slate-200">{selectedResult.title}</h3>
                ...
                <div className="space-y-3.5 pt-2">
                  ...
                  <div className="bg-slate-50 dark:bg-[#0f172a] border border-slate-100 dark:border-slate-800/80 rounded-2xl p-4.5 space-y-3 text-xs font-semibold text-slate-600 dark:text-slate-300">
                    <div className="flex justify-between items-center text-slate-900 dark:text-slate-100 border-b border-slate-200/55 dark:border-slate-800 pb-2.5">
                      ...
                      <span className="font-black text-sm text-emerald-600 dark:text-emerald-400">{Math.round(selectedResult.payload.monthlyInstallmentBeforeRetirement).toLocaleString('ar-SA')} ريال</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center text-slate-500 dark:text-slate-400 border-b border-slate-200/55 dark:border-slate-800 pb-2.5">
                      ...
                      <span className="font-black text-slate-800 dark:text-slate-200">{selectedResult.payload.termMonths} شهراً ({Math.round(selectedResult.payload.termMonths / 12)} سنة)</span>
                    </div>
                    ...
                    <div className="flex justify-between items-center text-slate-500 dark:text-slate-400 pb-1">
                      ...
                      <span className="font-black text-slate-800 dark:text-slate-200">{selectedResult.payload.annualMargin}%</span>
                    </div>
                  </div>
                </div>
              </div>
